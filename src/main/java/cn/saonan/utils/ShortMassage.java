...
public class ShortMassage {
	...
	public static final String TEMPLATE_1 = "159419";
	public static final String TEMPLATE_2 = "159488";
	
	public static void mobileQuery(String mobile, String tpl_id, String method){
		String result =null;
		String url ="http://v.juhe.cn/sms/send";//请求接口地址
		Map<String, String> params = new HashMap<String, String>();//请求参数
			params.put("mobile",mobile);//接受短信的用户手机号码
            params.put("tpl_id",tpl_id);//您申请的短信模板ID，根据实际情况修改
            //params.put("tpl_value",#code#=123");//您设置的模板变量，根据实际情况修改
			params.put("key","e3eb249cbe812ca35e14a2f72ca010d1");//应用APPKEY(应用详细页查询)
		try {
